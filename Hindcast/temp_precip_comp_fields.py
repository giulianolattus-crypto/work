...
t_Andes_ssavg_SON = process_region(SON_mean[["t2m"]], **SOUTH_SA)
t_Andes_ssavg_DJF = process_region(DJF_mean[["t2m"]], **SOUTH_SA)

print(t_Andes_ssavg_SON)

# SSA precipitation, SON and DJF
pr_era_Andes_ssavg_SON = process_region(SON_mean[["tprate"]], **SOUTH_SA)
pr_era_Andes_ssavg_DJF = process_region(DJF_mean[["tprate"]], **SOUTH_SA)

#plot mean maps

for i, array in enumerate([t_Andes_ssavg_SON, t_Andes_ssavg_DJF, pr_era_Andes_ssavg_SON, pr_era_Andes_ssavg_DJF]):
...
ds_Andes_DJF.to_netcdf(save_path+save_folder+'/Target_vars_DJF_areas.nc', encoding=encoding)
print('Summer SSA field saved')
ds_Andes_SON.to_netcdf(save_path+save_folder+'/Target_vars_SON_areas.nc', encoding=encoding)
print('Spring SSA field saved')

print('All saved!')


print('Temperature and Precipitation Fields Computation finished!')